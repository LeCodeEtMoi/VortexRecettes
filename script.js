...
document.addEventListener("DOMContentLoaded", function () {
    ...
    var type = params.get("type"); // "ramen" ou "tartinades"
    ...
    var updateRecipe = function (recipeIndex) {
        var recette = info[recipeIndex];
        if (!recette) {
        ...
        var createurElement = document.getElementById("auteur");
        var ingredientsElement = document.getElementById("ingredients");
        var etapesElement = document.getElementById("etapes");
        var tempsPreparationElement = document.getElementById("temps_preparation");
        // Mettre à jour les contenus
        titreElement.textContent = recette.nom;
        createurElement.textContent = "Cr\u00E9ateur : ".concat(recette.createur);
        tempsPreparationElement.textContent = "Temps de pr\u00E9paration : ".concat(recette.temps_preparation);
        ...
        recette.consignes.forEach(function (etape) {
            var li = document.createElement("li");
    ...
    var nextRecipeBtn = document.getElementById("nextRecipeBtn");
    if (nextRecipeBtn) {
