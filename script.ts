// Définition de l'interface Ramen
interface recettes {
    nom: string;
    createur: string;
    ingredients: string[];
...
const TartinadeRecipes: recettes[] = [
    {
...
const TartesRecipes: recettes[] = [
    ...
    },
    {
        ...
        },
        {
            ...
            consignes: [
                "Faire tremper le riz dans de l'eau chaude pendant 15 à 20 minutes.",
                "Émincer l'oignon ou écraser l'ail et les faire revenir dans l'huile d'olive chaude sans brunir.",
                "Rincer le riz sous l'eau jusqu'à ce que l'eau soit claire, puis l'ajouter dans la sauteuse.",
                "Ajouter le sel et les 60cl d'eau, porter à ébullition.",
                "Couvrir et cuire à feu doux pendant 10 minutes.",
                "Si le riz manque d'eau, ajouter un peu d'eau pour qu'il soit fondant."
            ],
            temps_preparation: "30 min"
        },
        {
            nom: "Dhal lentilles blondes poireaux potimarron",
            createur: "Kumquat",
            ingredients: [
                "1 petit poireau",
                "1 demi potimarron",
                ...
                "200ml de lait de coco",
                "200ml de crème de coco",
                "Épices curry (curry balti, garam masala)",
                "1 cuillère à café de sel",
                "Huile neutre",
                "Eau"
            ],
            consignes: [
                "Couper le poireau en lamelles et le potimarron en cubes.",
                "Faire chauffer 2 cuillères d'huile dans une cocotte et faire revenir les cubes de potimarron 3 minutes.",
                "Ajouter les poireaux et faire revenir 3 minutes supplémentaires.",
                "Ajouter les lentilles, le lait, la crème, et de l'eau pour couvrir tous les ingrédients.",
                "Assaisonner avec les épices et le sel, mélanger et couvrir.",
                "Cuire 20 minutes, vérifier la cuisson des lentilles, puis mijoter 5 minutes supplémentaires si nécessaire."
            ],
        ...
        },
        {
            ...
            consignes: [
                "Mettre 56g de gros sel dans un bocal d'un litre.",
                "Faire bouillir de l'eau minérale à 60°C.",
                "Remplir le bocal avec l'eau bouillante jusqu'en haut pour couvrir les olives.",
                "Stocker pendant 1 an."
            ],
            temps_preparation: "1 an"
        },
        {
            ...
            ingredients: [
                ...
                "Huile de noix",
                "Sauce soja",
                "Fromage (chèvre frais ou bleu)"
            ],
            consignes: [
                "Évider les tomates et réserver la pulpe.",
                "Mélanger la farce : patate, champignons, oignon, huile de noix et sauce soja.",
                "Ajouter le fromage en morceaux à la farce.",
                "Garnir les tomates avec la farce.",
                "Cuire au four à 200°C pendant 1h15 (baisser à 180°C après 30 minutes)."
            ],
            temps_preparation: "1h30"
        },
        {
            ...
            createur: "zA",
            ingredients: [
                "1 chou rouge (sans trognon, maximum 1.5kg)",
                "4 oignons moyens",
                "4 à 6 pommes",
                "1 verre de vin rouge ou 1/2 verre de vinaigre de vin rouge ou cidre",
                "2 verres d'eau",
                "1,5 cuillère à soupe de gros sel"
            ],
            consignes: [
                "Émincer le chou rouge, retirer les côtes épaisses.",
                "Couper les oignons grossièrement et les faire revenir dans une cocotte avec du beurre ou de l'huile.",
                "Ajouter le chou, les liquides (vin/vinaigre, eau) et le sel.",
                "Cuire à feu doux 45 minutes (ou 15 minutes en autocuiseur).",
                "Ajouter les pommes coupées en morceaux et cuire encore 20 minutes (ou 10 en autocuiseur)."
            ],
            temps_preparation: "1h10"
        },
        {
            nom: "Bretzels",
            createur: "Hibou",
            ingredients: [
                "500g de farine T65",
                "5g de levure sèche ou 12g de levure fraîche",
                "40g de sucre",
                "75g de beurre fondu",
                "8g de sel",
                "125ml de lait tiède",
                "125ml d'eau chaude",
                "Sésame, pavot ou fleur de sel pour la garniture"
            ],
            consignes: [
                "Mélanger tous les ingrédients et pétrir 10 minutes.",
                "Laisser lever la pâte jusqu'à ce qu'elle double de volume.",
                "Diviser en 10 pâtons, former des boudins de 40cm et les nouer en bretzels.",
                "Préparer un bain de pochage avec de l'eau chaude, du bicarbonate et du sel.",
                "Pocher les bretzels jusqu'à ce qu'ils flottent, les déposer sur une plaque.",
                "Ajouter les garnitures et cuire au four à 200°C pendant 20 minutes."
            ],
            temps_preparation: "1h30"
        },
        {
            ...
            consignes: [
                ...
                "Ajouter de l'eau si nécessaire pendant la cuisson."
            ],
            temps_preparation: "1h30"
        },
        {
            ...
            ingredients: [
                ...
                "Panure",
                "Farine",
                "1 œuf ou lait végétal",
                "Huile pour la friture"
            ],
            consignes: [
                "Congeler et décongeler le tofu deux fois pour obtenir une texture fibreuse.",
                "Déchirer le tofu en morceaux.",
                "Mélanger paprika et sel à la farine.",
                "Rouler les morceaux dans le mélange de farine, puis dans l'œuf ou le lait végétal, et enfin dans la panure.",
                "Faire frire dans une casserole avec 1cm d'huile jusqu'à ce qu'ils soient dorés."
            ],
            temps_preparation: "30 min"
        }
    ];

    const ChaosVRecipes: recettes[] = [
        {
            nom: "Chaos végé - Dahl de lentilles corail",
            createur: "Anonyme",
            ingredients: [
                "80 à 100g de lentilles corail par personne",
                "1 oignon jaune",
            ...
            consignes: [
                "Couper les oignons et les faire suer.",
                "Ajouter le curry et mélanger jusqu'à ce que l'odeur soit agréable.",
                "Ajouter les lentilles corail (précuites ou crues).",
                "Arroser avec de l'eau ou du bouillon et laisser frémir à feu moyen.",
                "Laisser cuire jusqu'à réduction, puis ajouter le lait de coco ou la crème.",
                "Ajouter du persil, de la menthe ou du basilic en option.",
                "Servir avec du riz ou du tofu."
            ],
            temps_preparation: "30 min"
        },
        {
            nom: "Crackers maisons de Maman-Pha qui déchirent",
            createur: "Maman-Pha",
            ingredients: [
                "30g de flocons d'avoine",
                "150g de farine",
                "1 poignée d'olives noires en morceaux",
                "50g d'huile d'olive",
                "130g d'eau (ajuster selon la consistance)",
                "2 cuillères à café de concentré de tomates",
                "1 cuillère à café de sel",
                "Herbes de Provence ou autres herbes au choix"
            ],
            consignes: [
                "Mélanger tous les ingrédients jusqu'à obtenir une pâte homogène.",
                "Étaler la pâte entre deux feuilles de papier sulfurisé.",
                "Cuire au four à 180°C pendant 20 minutes (ou plus pour plus de croustillant).",
                "Laisser refroidir avant de déguster."
            ],
            temps_preparation: "30 min"
        },
        {
            nom: "Focaccia facile mais longue",
            createur: "Kumquat",
            ingredients: [
                "400g + 1 cuillère à café de farine T45 ou Typo 00",
                "320g d'eau",
                "1 sachet de levure boulangère (8g)",
                "15g d'huile d'olive pour la pâte",
                "8g de sel",
                "Huile d'olive en masse pour le dessus"
            ],
            consignes: [
                "Mélanger l'eau et la farine dans un saladier, laisser reposer 45 minutes à 1h.",
                "Ajouter la levure diluée dans un peu d'eau tiède avec une cuillère de farine.",
                "Incorporer l'huile et le sel, mélanger, puis laisser lever 1h dans un endroit chaud.",
                "Pétrir la pâte avec des mains mouillées en pliant plusieurs fois.",
                "Laisser lever à nouveau 1h, puis transférer dans un plat huilé.",
                "Étaler, laisser lever encore 1h, puis faire des trous avec les doigts huilés.",
                "Ajouter des garnitures au choix (tomates cerises, olives, herbes).",
                "Cuire à 230°C pendant 20 minutes."
            ],
            temps_preparation: "3-4h avec les temps de repos"
        },
        {
            nom: "Choux-fleur rôti avec sauce menthe-citron",
            createur: "Iria",
            ingredients: [
                "1 chou-fleur",
                "Épices cajun",
                ...
                "Zeste de 1/2 citron",
                "Jus de citron",
                "1 cuillère d'épices cajun",
                "Miel"
            ],
            consignes: [
                "Préchauffer le four à 180°C.",
                "Retirer les feuilles et le pied du chou-fleur, le couper en tranches de 1,5 cm.",
                "Assaisonner avec les épices, le sel, l'huile et des noisettes de beurre.",
                "Cuire 20 minutes, retourner et cuire 20 minutes supplémentaires.",
                "Mélanger le yaourt, la menthe, le zeste et le jus de citron, le miel et les épices pour la sauce.",
                "Servir le chou-fleur rôti avec la sauce."
            ],
            temps_preparation: "1h"
        },
        {
            nom: "Pakora Aloo (Beignets de pomme de terre)",
            createur: "Hibou",
            ingredients: [
                "800g de pommes de terre variété ferme",
                ...
                "3 pincées de fenugrec",
                "Piment",
                "Sel"
            ],
            consignes: [
                "Couper les pommes de terre en brunoise et les cuire à l'eau bouillante (6-8 minutes).",
                "Émincer finement l'oignon.",
                "Mélanger tous les ingrédients pour former une pâte.",
                "Faire frire de petites portions dans une sauteuse avec un fond d'huile chaude."
            ],
            temps_preparation: "45 min"
        },
        {
            ...
            ingredients: [
                ...
                "Cumin",
                "Curry",
                "Légumes au choix (courge, légumes congelés ou patates)"
            ],
            consignes: [
                "Faire revenir le concentré de tomates avec les épices dans un peu d'huile.",
                "Ajouter les pois chiches, le lait de coco et les légumes.",
        ...
        },
        {
            ...
            consignes: [
                "Rouler les tranches de feta dans la farine, l'œuf battu, puis la chapelure.",
                "Faire frire 3 minutes de chaque côté dans une poêle avec de l'huile.",
                "Servir chaud."
            ],
            temps_preparation: "15 min"
        }
    ];
    const ChaosNVRecipes: recettes[] = [
        {
    ...
    const BoissonsRecipes: recettes[] = [
        {
            nom: "Cocktail d'Oldu",
            createur: "Inconnu",
            ingredients: [
    ...
    document.addEventListener("DOMContentLoaded", () => {
        // Récupérer le type de recettes depuis l'URL
        const params = new URLSearchParams(window.location.search);
        const type = params.get("type"); // "ramen" ou "tartinades"
    
        // Sélectionner la bonne liste de recettes
        let info: recettes[] = [];
        if (type === "ramen") {
            info = ramenRecipes;
        } else if (type === "tartinades") {
            info = TartinadeRecipes;
        } else if (type === "soupe") {
            info = SoupeRecipes;
        } else if (type === "tartes") {
            info = TartesRecipes;
            ...
            info = ChaosVRecipes;
        } else if (type === "chaosPV") {
            info = ChaosNVRecipes;
        } else if (type === "gâteaux") {
            info = Gateaux;
        } else if (type === "boissons") {
            info = BoissonsRecipes;
        } else {
            console.error("Type de recettes inconnu :", type);
        ...
        const updateRecipe = (recipeIndex: number) => {
            const recette = info[recipeIndex];
            if (!recette) {
                console.error("Aucune recette trouvée à l'index :", recipeIndex);
                return;
            }
    
            // Sélection des éléments HTML
            const titreElement = document.getElementById("title") as HTMLHeadingElement;
            const createurElement = document.getElementById("auteur") as HTMLHeadingElement;
            const ingredientsElement = document.getElementById("ingredients") as HTMLElement;
            const etapesElement = document.getElementById("etapes") as HTMLElement;
            const tempsPreparationElement = document.getElementById("temps_preparation") as HTMLElement;
    
            // Mettre à jour les contenus
            titreElement.textContent = recette.nom;
            createurElement.textContent = `Créateur : ${recette.createur}`;
            tempsPreparationElement.textContent = `Temps de préparation : ${recette.temps_preparation}`;
            ...
            etapesElement.innerHTML = "";
            recette.consignes.forEach((etape) => {
                const li = document.createElement("li");
                li.textContent = etape;
                etapesElement.appendChild(li);
            });
        };
        ...
        // Bouton pour passer à la recette suivante
        const nextRecipeBtn = document.getElementById("nextRecipeBtn") as HTMLButtonElement;
        if (nextRecipeBtn) {
            nextRecipeBtn.addEventListener("click", () => {
                currentRecipeIndex = (currentRecipeIndex + 1) % info.length; // Boucler les recettes
                updateRecipe(currentRecipeIndex);
            });
        }
    });
